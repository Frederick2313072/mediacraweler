                ...
                with open(os.path.join(json_dir, json_file), 'r', encoding='utf-8') as jf:
                    ...
                    if 'search_contents' in json_file:
                        ...
                        for comment in data:
                            ...
                            if content_id not in comments_data:
                                comments_data[content_id] = []
                            comments_data[content_id].append(comment)
            except Exception as e:
            ...
            for content in contents_data:
                try:
                    ...
                    with open(content_file, 'w', encoding='utf-8') as cf:
                        ...
                        # 写入评论
                        if content_id in comments_data:
                            cf.write('## 评论\n\n')
                            for comment in comments_data[content_id]:
